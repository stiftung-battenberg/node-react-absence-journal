...
export default function CreateJournalWeek (props) {
                ...
                <div className="relative w-full h-full max-w-2xl px-4 md:h-auto">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form onSubmit={(e)=>{handleSubmit(e)}}>
                            <label className="text-sm font-normal text-gray-600 mb-2 m-6 mt-12" >{t("Date of week of the journal")}</label>
                            <div className="flex items-center border-2 rounded-2xl mx-6 my-3">
                                <input className="pl-2 outline-none border-none w-full" type="Date" value={date} placeholder="Date of the week" onChange={(e) => {setdate(e.target.value)}} />
                            </div>
